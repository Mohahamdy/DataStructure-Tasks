    ...
    void BubbleSort()
{
    ...
    int BinarySearch(int value)
    {
        ...
        while (start != end && start != NULL && end != NULL)
        {
            ...
            Node* midNode = getNodeBYData(midValue);
            if (midValue == value)
            {
                return 1;
            }
...
//    void BubbleSort()
//    {
//        Node *nodeSoretd = Head;
//        while(nodeSoretd->Next == NULL)
//        {
//            if(nodeSoretd->data > nodeSoretd->Next->data)
//            {
//                Node* nodeExist = nodeSoretd->Next;
//                Node *nodeDelet =Delete(nodeSoretd);
//                AddAfterNode(nodeDelet,nodeExist);
//            }
//            nodeSoretd= nodeSoretd->Next;
//        }
//    }
///////////////////////////////////////////////////////

//    Node* Delete(Node* nodeDeleted)
//    {
//        if(nodeDeleted == NULL)
//            return NULL;
//        if(nodeDeleted == Head)
...
//    void AddAfterNode(Node *nodeAdded,Node *nodeExist)
//    {
//       if(nodeExist == Tail)
//        {
//            Tail->Next = nodeAdded;
...
//        else
//        {
//            nodeAdded->Prev = nodeExist;
//            nodeAdded->Next = nodeExist->Next;
//            nodeExist->Next->Prev = nodeAdded;
//            nodeExist->Next = nodeAdded;
//        }
//    }
